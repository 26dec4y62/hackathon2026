...
const HIGHLIGHTS = [
  ...
  { code:"E4",  avgRent:"£1,450",  commute:"32 min",  bars:14  },
  { code:"E5",  avgRent:"£1,520",  commute:"35 min",  bars:12  },
  { code:"E6",  avgRent:"£1,380",  commute:"40 min",  bars:8   },
  { code:"E7",  avgRent:"£1,420",  commute:"38 min",  bars:10  },
  { code:"E8",  avgRent:"£1,800",  commute:"24 min",  bars:38  },
  { code:"E9",  avgRent:"£1,650",  commute:"28 min",  bars:22  },
  { code:"E10", avgRent:"£1,480",  commute:"34 min",  bars:16  },
  { code:"E11", avgRent:"£1,420",  commute:"36 min",  bars:14  },
  { code:"E12", avgRent:"£1,350",  commute:"38 min",  bars:10  },
  { code:"E13", avgRent:"£1,280",  commute:"42 min",  bars:6   },
  { code:"E14", avgRent:"£1,950",  commute:"26 min",  bars:28  },
  { code:"E15", avgRent:"£1,520",  commute:"40 min",  bars:12  },
  { code:"E16", avgRent:"£1,380",  commute:"44 min",  bars:8   },
  { code:"E17", avgRent:"£1,450",  commute:"42 min",  bars:10  },
  { code:"E18", avgRent:"£1,320",  commute:"45 min",  bars:6   },
  { code:"EC1", avgRent:"£2,400",  commute:"8 min",   bars:56  },
  { code:"EC2", avgRent:"£2,350",  commute:"6 min",   bars:52  },
  { code:"EC3", avgRent:"£2,280",  commute:"8 min",   bars:48  },
  { code:"EC4", avgRent:"£2,420",  commute:"10 min",  bars:50  },
  { code:"N1",  avgRent:"£2,100",  commute:"18 min",  bars:42  },
  { code:"N2",  avgRent:"£2,050",  commute:"26 min",  bars:24  },
  { code:"N3",  avgRent:"£1,980",  commute:"32 min",  bars:16  },
  ...
  { code:"N7",  avgRent:"£1,920",  commute:"24 min",  bars:28  },
  { code:"N8",  avgRent:"£1,880",  commute:"28 min",  bars:22  },
  { code:"N9",  avgRent:"£1,620",  commute:"38 min",  bars:12  },
  { code:"N10", avgRent:"£1,750",  commute:"32 min",  bars:14  },
  { code:"N11", avgRent:"£1,680",  commute:"36 min",  bars:10  },
  { code:"N12", avgRent:"£1,620",  commute:"40 min",  bars:8   },
  { code:"N13", avgRent:"£1,550",  commute:"42 min",  bars:6   },
  { code:"N14", avgRent:"£1,720",  commute:"38 min",  bars:12  },
  { code:"N15", avgRent:"£1,580",  commute:"40 min",  bars:8   },
  { code:"N16", avgRent:"£1,750",  commute:"30 min",  bars:34  },
  { code:"N17", avgRent:"£1,620",  commute:"38 min",  bars:10  },
  { code:"N18", avgRent:"£1,520",  commute:"42 min",  bars:6   },
  { code:"N19", avgRent:"£1,880",  commute:"32 min",  bars:20  },
  { code:"N20", avgRent:"£1,720",  commute:"40 min",  bars:10  },
  { code:"N21", avgRent:"£1,650",  commute:"44 min",  bars:8   },
  { code:"N22", avgRent:"£1,580",  commute:"42 min",  bars:8   },
  { code:"NW1", avgRent:"£2,050",  commute:"14 min",  bars:62  },
  { code:"NW2", avgRent:"£1,980",  commute:"22 min",  bars:26  },
  { code:"NW3", avgRent:"£2,900",  commute:"30 min",  bars:12  },
  { code:"NW4", avgRent:"£2,150",  commute:"36 min",  bars:18  },
  { code:"NW5", avgRent:"£1,820",  commute:"22 min",  bars:26  },
  { code:"NW6", avgRent:"£1,780",  commute:"20 min",  bars:22  },
  { code:"NW7", avgRent:"£1,920",  commute:"38 min",  bars:14  },
  { code:"NW8", avgRent:"£2,200",  commute:"24 min",  bars:20  },
  { code:"NW9", avgRent:"£1,850",  commute:"40 min",  bars:12  },
  { code:"NW10", avgRent:"£1,720",  commute:"38 min",  bars:10  },
  { code:"NW11", avgRent:"£1,880",  commute:"44 min",  bars:8   },
  { code:"SE1", avgRent:"£2,200",  commute:"10 min",  bars:54  },
  { code:"SE2", avgRent:"£1,520",  commute:"38 min",  bars:12  },
  { code:"SE3", avgRent:"£1,650",  commute:"34 min",  bars:14  },
  { code:"SE4", avgRent:"£1,620",  commute:"30 min",  bars:18  },
  { code:"SE5", avgRent:"£1,640",  commute:"26 min",  bars:26  },
  { code:"SE6", avgRent:"£1,480",  commute:"40 min",  bars:10  },
  { code:"SE7", avgRent:"£1,420",  commute:"42 min",  bars:8   },
  { code:"SE8", avgRent:"£1,580",  commute:"28 min",  bars:28  },
  { code:"SE9", avgRent:"£1,450",  commute:"44 min",  bars:6   },
  { code:"SE10", avgRent:"£1,880",  commute:"22 min",  bars:24  },
  { code:"SE11", avgRent:"£1,900",  commute:"16 min",  bars:30  },
  { code:"SE12", avgRent:"£1,520",  commute:"38 min",  bars:10  },
  { code:"SE13", avgRent:"£1,580",  commute:"36 min",  bars:12  },
  { code:"SE14", avgRent:"£1,720",  commute:"32 min",  bars:16  },
  { code:"SE15", avgRent:"£1,650",  commute:"28 min",  bars:44  },
  { code:"SE16", avgRent:"£1,720",  commute:"24 min",  bars:20  },
  { code:"SE17", avgRent:"£1,680",  commute:"28 min",  bars:18  },
  { code:"SE18", avgRent:"£1,420",  commute:"44 min",  bars:8   },
  { code:"SE19", avgRent:"£1,520",  commute:"42 min",  bars:10  },
  { code:"SE20", avgRent:"£1,450",  commute:"46 min",  bars:6   },
  { code:"SE21", avgRent:"£1,680",  commute:"38 min",  bars:14  },
  { code:"SE22", avgRent:"£1,780",  commute:"32 min",  bars:20  },
  { code:"SE23", avgRent:"£1,620",  commute:"38 min",  bars:12  },
  { code:"SE24", avgRent:"£1,750",  commute:"36 min",  bars:16  },
  { code:"SE25", avgRent:"£1,580",  commute:"40 min",  bars:10  },
  { code:"SE26", avgRent:"£1,520",  commute:"44 min",  bars:8   },
  { code:"SE27", avgRent:"£1,450",  commute:"46 min",  bars:6   },
  { code:"SE28", avgRent:"£1,320",  commute:"50 min",  bars:4   },
  { code:"SW1", avgRent:"£3,100",  commute:"12 min",  bars:80  },
  { code:"SW2", avgRent:"£1,850",  commute:"20 min",  bars:32  },
  { code:"SW3", avgRent:"£2,950",  commute:"16 min",  bars:44  },
  { code:"SW4", avgRent:"£2,000",  commute:"22 min",  bars:36  },
  { code:"SW5", avgRent:"£2,850",  commute:"18 min",  bars:40  },
  { code:"SW6", avgRent:"£2,200",  commute:"24 min",  bars:32  },
  { code:"SW7", avgRent:"£2,750",  commute:"14 min",  bars:38  },
  { code:"SW8", avgRent:"£2,100",  commute:"20 min",  bars:28  },
  { code:"SW9", avgRent:"£1,750",  commute:"18 min",  bars:52  },
  { code:"SW10", avgRent:"£2,450",  commute:"22 min",  bars:34  },
  { code:"SW11", avgRent:"£2,100",  commute:"24 min",  bars:28  },
  { code:"SW12", avgRent:"£1,820",  commute:"28 min",  bars:20  },
  { code:"SW13", avgRent:"£1,950",  commute:"26 min",  bars:24  },
  { code:"SW14", avgRent:"£1,880",  commute:"32 min",  bars:18  },
  { code:"SW15", avgRent:"£2,050",  commute:"30 min",  bars:22  },
  { code:"SW16", avgRent:"£1,720",  commute:"36 min",  bars:14  },
  { code:"SW17", avgRent:"£1,680",  commute:"34 min",  bars:12  },
  { code:"SW18", avgRent:"£1,920",  commute:"32 min",  bars:20  },
  { code:"SW19", avgRent:"£1,850",  commute:"36 min",  bars:16  },
  { code:"SW20", avgRent:"£1,780",  commute:"38 min",  bars:14  },
  { code:"W1",  avgRent:"£3,200",  commute:"5 min",   bars:120 },
  { code:"W2",  avgRent:"£2,600",  commute:"12 min",  bars:46  },
  { code:"W3",  avgRent:"£1,950",  commute:"28 min",  bars:22  },
  { code:"W4",  avgRent:"£1,880",  commute:"26 min",  bars:24  },
  { code:"W5",  avgRent:"£1,720",  commute:"34 min",  bars:18  },
  { code:"W6",  avgRent:"£2,150",  commute:"24 min",  bars:32  },
  { code:"W7",  avgRent:"£1,820",  commute:"32 min",  bars:20  },
  { code:"W8",  avgRent:"£2,450",  commute:"16 min",  bars:36  },
  { code:"W9",  avgRent:"£2,200",  commute:"18 min",  bars:40  },
  { code:"W10", avgRent:"£2,050",  commute:"20 min",  bars:34  },
  { code:"W11", avgRent:"£3,100",  commute:"20 min",  bars:38  },
  { code:"W12", avgRent:"£1,900",  commute:"22 min",  bars:30  },
  { code:"W13", avgRent:"£1,780",  commute:"36 min",  bars:16  },
  { code:"W14", avgRent:"£2,100",  commute:"28 min",  bars:28  },
  { code:"WC1", avgRent:"£2,500",  commute:"8 min",   bars:44  },
  { code:"WC2", avgRent:"£2,480",  commute:"6 min",   bars:48  },
];
      ...
      <div className="hero">
        <div className="hero-left">
          ...
          <h1 className="hero-title">
            Where<br/><em>you</em><br/>should<br/><em>live</em>
          </h1>
